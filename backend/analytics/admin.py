...
class SellerAnalyticsAdmin(admin.ModelAdmin):
    list_display = ('seller', 'total_revenue', 'total_orders', 'total_books_sold', 'last_updated')
...
class DailySalesAdmin(admin.ModelAdmin):
    list_display = ('seller', 'date', 'revenue', 'orders', 'books_sold')
    list_filter = ('date', 'seller')
    search_fields = ('seller__email',)
    readonly_fields = ('date',)

@admin.register(BookPerformance)
class BookPerformanceAdmin(admin.ModelAdmin):
    list_display = ('book', 'views', 'purchases', 'revenue', 'conversion_rate')
    list_filter = ('last_updated',)
...
class InventoryAlertAdmin(admin.ModelAdmin):
    list_display = ('seller', 'book', 'alert_type', 'priority', 'is_resolved', 'created_at')
    list_filter = ('alert_type', 'priority', 'is_resolved', 'created_at')
    search_fields = ('seller__email', 'book__title')
    readonly_fields = ('created_at', 'resolved_at')
    list_editable = ('is_resolved',)

@admin.register(SalesReport)
class SalesReportAdmin(admin.ModelAdmin):
    list_display = ('seller', 'report_type', 'start_date', 'end_date', 'total_revenue', 'created_at')
